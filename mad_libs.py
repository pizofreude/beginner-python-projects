...
Label(root, text="  Let's have some fun!  \n   Be a man!  ", fg='darkred', bg='lightgreen', font='comicsans 14 italic').pack()
Label(root, text="\nFreedom of choice, select any of these options: ", font='timesnewroman 14 bold').place(x=100,y=100)
...
# Define Buttons:
Button(root, text='The Photographer', command=madlib1, font='comicsans 12 italic').pack(expand=True)
Button(root, text='The Butterfly', command=madlib2, font='comicsans 12 italic').pack(expand=True)
Button(root, text='The Apple', command=madlib3, font='comicsans 12 italic').pack(expand=True)
root.mainloop()
