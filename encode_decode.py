...
root.title('HafeezEn-/De-cryption - Encoding & Decoding')
Label(root, text='Encode - Decode', font='timesnewroman 20 italic', fg='gold').pack()
Label(root, text='Pizofreude© ℗®™', font='arielblack 20 bold', fg='red').pack(side=BOTTOM)
